...
def main() -> int:
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        val_loss, val_metrics = evaluate(model, val_loader, criterion, device, use_amp, args.threshold, epoch)
        ...
        logger.info(
            "Epoch %03d | train_loss=%.5f | val_loss=%.5f | auc=%.5f | acc=%.5f | f1=%.5f | sens=%.5f | spec=%.5f",
            epoch,
            train_loss,
            val_loss,
            val_metrics["auc"],
